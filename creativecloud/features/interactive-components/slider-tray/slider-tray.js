...
function selectorTrayWithImgs(layer, data) {
  ...
  const productSvgLR = `<svg xmlns="http://www.w3.org/2000/svg" id="Lightroom_40" data-name="Lightroom 40" width="40" height="39" viewBox="0 0 40 39">
  ...
  const productSvgPS = `<svg id="Photoshop_40" data-name="Photoshop 40" xmlns="http://www.w3.org/2000/svg" width="40" height="39" viewBox="0 0 40 39">
  ...
  let productSvg = productSvgLR;
  if (continueCTA && continueCTA.innerText && continueCTA.innerText.toLowerCase().includes('photoshop')) productSvg = productSvgPS;
